...
def list_projects(project_number, root_path):
    """Gets list of projects in the main project folder and selects matching projects"""
...
def open_project_folder(project_number, root_folder):
    """Gets matching folders and opens appropriate ui window"""
...
def main():
    """Opens main serach page and runs interface"""
    root = tk.Tk()
